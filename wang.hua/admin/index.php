...
$empty_product = (object)[
   "title"=>"Large Rainbow",
   "description"=>"The large Rainbow is really versatile: small children stack, sort and build and as the children get older they will use it as a cradle for dolls, as fence for animals, like a tunnel or bridge for vehicles... ",
   "category"=>"3 years old",
   "price"=>"96.00",
   "thumbnail"=>"rainbow.jpeg",
   "images"=>"rainbow.jpeg,rainbow_1.jpeg,rainbow_2.jpeg",
   "quantity"=>"50"
];
